...
if __name__ == "__main__":
    ...
    args = parser.parse_args() dispatcher = dispatcher.Dispatcher()
 ...
 # dispatcher.map("/muse/elements/experimental/mellow", mellow_handler,"MELLOW") # dispatcher.map("/muse/eeg", eeg_handler, "EEG") server = osc_server.ThreadingOSCUDPServer(
